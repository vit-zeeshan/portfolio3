      ...
      <SheetContent side="left" className="w-[240px] sm:w-[280px] flex flex-col">
          ...
          {sections.map((section) => (
            <SheetClose key={section} asChild>
              <button
                ...
                className={`w-full text-left px-4 py-2 text-sm capitalize rounded-md transition-colors ${activeSection === section
        ...
        <div className="mt-auto pt-6 border-t border-border/40">
          ...
          <div className="text-center text-sm text-muted-foreground mt-4 px-4">
            <p>© {new Date().getFullYear()} Zeeshan Raza</p>
          </div>
        </div>
      </SheetContent>
    </Sheet>
